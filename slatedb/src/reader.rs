...
impl Reader {
    ...
    fn build_memtable_iters(
        ...
        memtables
            .iter()
            .map(|table| {
                Box::new(table.range_with_read_trace(range.clone(), order, read_trace.clone()))
...
mod tests {
    ...
    fn should_record_memtable_read_spans_for_get_with_tracing_options() -> Result<(), SlateDBError>
    {
        ...
        let read_options =
            ReadOptions::default().with_tracing_options(Some(TracingOptions::new("get-trace")));
        ...
        assert_recorded_memtable_read_spans(&span_recorder, "get-trace");
        Ok(())
    }
    ...
    fn should_record_memtable_read_spans_for_scan_with_tracing_options() -> Result<(), SlateDBError>
    {
        ...
        assert_recorded_memtable_read_spans(&span_recorder, "scan-trace");
        Ok(())
    }
    ...
    fn should_record_memtable_read_spans_for_recency_scan_with_tracing_options(
        ...
        let scan_options = ScanOptions::default()
            .with_tracing_options(Some(TracingOptions::new("recency-scan-trace")));
        ...
        assert_recorded_memtable_read_spans(&span_recorder, "recency-scan-trace");
        Ok(())
    }
